  ...
  return (
    <div className="map-filters">
      ...
      <label><span>Место</span>
        <input value={v.location || ''} onChange={(e) => set('location', e.target.value)} placeholder="Введите адрес" />
      </label>
      <button className="btn btn--ghost btn--full" onClick={onReset}>Сбросить</button>

      <div className="map-legend">
        <div><span className="dot dot--green" /> Без пострадавших</div>
        <div><span className="dot dot--yellow" /> 1–2 пострадавших</div>
