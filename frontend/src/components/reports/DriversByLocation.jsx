// frontend/src/components/reports/DriversByLocation.jsx
...
export default function DriversByLocation() {
  ...
  return (
    <ReportCard
      number={2}
      title="Водители, участвовавшие в ДТП по указанному месту"
    >
      ...
      {data && (
        <table className="data-table">
          <thead>
            <tr><th>ФИО</th><th>Гос. номер</th><th>Дата</th><th>Место</th><th>Вид</th><th>Причина</th></tr>
          </thead>
          <tbody>
            {data.map((r, i) => (
